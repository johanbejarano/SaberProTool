...
*/
@Scope("singleton")
@Service("EstadoPruebaLogic")
public class EstadoPruebaLogic implements IEstadoPruebaLogic {
    private static final Logger log = LoggerFactory.getLogger(EstadoPruebaLogic.class);

    /**
     * DAO injected by Spring that manages EstadoPrueba entities
     *
     */
    @Autowired
    private IEstadoPruebaDAO estadoPruebaDAO;
    @Autowired
    ...
    */
    ...
    public void deleteEstadoPrueba(EstadoPrueba entity)
        ...
        if (entity.getIdEstadoPrueba() == null) {
            throw new ZMessManager().new EmptyFieldException("idEstadoPrueba");
        }

        List<PruebaProgramaUsuario> pruebaProgramaUsuarios = null;

        try {
            pruebaProgramaUsuarios = pruebaProgramaUsuarioDAO.findByProperty("estadoPrueba.idEstadoPrueba",
                    entity.getIdEstadoPrueba());
            ...
            estadoPruebaDAO.deleteById(entity.getIdEstadoPrueba());
    ...
    public void updateEstadoPrueba(EstadoPrueba entity)
        ...
        try {
            ...
            estadoPruebaDAO.update(entity);

            log.debug("update EstadoPrueba successful");
        } catch (Exception e) {
    ...
    public EstadoPrueba getEstadoPrueba(Long idEstadoPrueba)
        ...
        try {
            entity = estadoPruebaDAO.findById(idEstadoPrueba);
        } catch (Exception e) {
    ...
    public List<EstadoPrueba> findPageEstadoPrueba(String sortColumnName,
        ...
        throws Exception {
        List<EstadoPrueba> entity = null;

        try {
            entity = estadoPruebaDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("EstadoPrueba Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<EstadoPrueba> findByCriteria(Object[] variables,
        ...
        try {
            list = estadoPruebaDAO.findByCriteria(where);
        } catch (Exception e) {
