...
@Scope("singleton")
@Service("ModuloLogic")
public class ModuloLogic implements IModuloLogic {
    private static final Logger log = LoggerFactory.getLogger(ModuloLogic.class);
    ...
    */
    ...
    public void deleteModulo(Modulo entity) throws Exception {
        ...
        if (entity.getIdModulo() == null) {
            throw new ZMessManager().new EmptyFieldException("idModulo");
        }
        ...
        try {
            preguntas = preguntaDAO.findByProperty("modulo.idModulo",
                    entity.getIdModulo());
            ...
            programaModulos = programaModuloDAO.findByProperty("modulo.idModulo",
                    entity.getIdModulo());
            ...
            pruebaModulos = pruebaModuloDAO.findByProperty("modulo.idModulo",
                    entity.getIdModulo());
            ...
            resultadoReals = resultadoRealDAO.findByProperty("modulo.idModulo",
                    entity.getIdModulo());
            ...
            moduloDAO.deleteById(entity.getIdModulo());
    ...
    public void updateModulo(Modulo entity) throws Exception {
        ...
        try {
            ...
            log.debug("update Modulo successful");
        } catch (Exception e) {
    ...
    public Modulo getModulo(Long idModulo) throws Exception {
        ...
        try {
            entity = moduloDAO.findById(idModulo);
        } catch (Exception e) {
    ...
    public List<Modulo> findPageModulo(String sortColumnName,
        ...
        try {
            entity = moduloDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Modulo Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<Modulo> findByCriteria(Object[] variables,
        ...
        try {
            list = moduloDAO.findByCriteria(where);
        } catch (Exception e) {
