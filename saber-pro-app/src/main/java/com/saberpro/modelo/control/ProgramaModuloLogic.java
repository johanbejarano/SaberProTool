...
*/
@Scope("singleton")
@Service("ProgramaModuloLogic")
public class ProgramaModuloLogic implements IProgramaModuloLogic {
    private static final Logger log = LoggerFactory.getLogger(ProgramaModuloLogic.class);
    ...
    */
    ...
    public List<ProgramaModulo> getProgramaModulo() throws Exception {
        ...
        List<ProgramaModulo> list = new ArrayList<ProgramaModulo>();

        try {
            list = programaModuloDAO.findAll();
        } catch (Exception e) {
            log.error("finding all ProgramaModulo failed", e);
    ...
    public List<ProgramaModulo> getProgramaModulo(String tipo) throws Exception {
        ...
        try {
            list = programaModuloDAO.findAll(tipo);
        } catch (Exception e) {
            log.error("finding all ProgramaModulo failed", e);
            throw new ZMessManager().new GettingException(ZMessManager.ALL +
                "ProgramaModulo");
    ...
    public void deleteProgramaModulo(ProgramaModulo entity)
        ...
        if (entity.getIdProgramaModulo() == null) {
            throw new ZMessManager().new EmptyFieldException("idProgramaModulo");
        }

        try {
            programaModuloDAO.deleteById(entity.getIdProgramaModulo());
    ...
    public void updateProgramaModulo(ProgramaModulo entity)
        ...
        try {
            ...
            programaModuloDAO.update(entity);

            log.debug("update ProgramaModulo successful");
        } catch (Exception e) {
    ...
    public List<ProgramaModuloDTO> getDataProgramaModulo()
        throws Exception {
        try {
            List<ProgramaModulo> programaModulo = programaModuloDAO.findAll();

            List<ProgramaModuloDTO> programaModuloDTO = new ArrayList<ProgramaModuloDTO>();

            for (ProgramaModulo programaModuloTmp : programaModulo) {
                ProgramaModuloDTO programaModuloDTO2 = programaModuloMapper.programaModuloToProgramaModuloDTO(programaModuloTmp);
                programaModuloDTO.add(programaModuloDTO2);
            }
    ...
    public List<ProgramaModuloDTO> getDataProgramaModulo(String tipo)
        throws Exception {
        try {
            List<ProgramaModulo> programaModulo = programaModuloDAO.findAll(tipo);
    ...
    public ProgramaModulo getProgramaModulo(Long idProgramaModulo)
        ...
        ProgramaModulo entity = null;

        try {
            entity = programaModuloDAO.findById(idProgramaModulo);
        } catch (Exception e) {
            log.error("get ProgramaModulo failed", e);
            throw new ZMessManager().new FindingException("ProgramaModulo");
        } finally {
        }
    ...
    public List<ProgramaModulo> findPageProgramaModulo(String sortColumnName,
        ...
        throws Exception {
        List<ProgramaModulo> entity = null;

        try {
            entity = programaModuloDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException(
                "ProgramaModulo Count");
        } finally {
        }
    ...
    public Long findTotalNumberProgramaModulo() throws Exception {
        ...
        try {
            entity = programaModuloDAO.count();
        } catch (Exception e) {
            throw new ZMessManager().new FindingException(
                "ProgramaModulo Count");
        } finally {
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<ProgramaModulo> findByCriteria(Object[] variables,
        ...
        try {
            list = programaModuloDAO.findByCriteria(where);
        } catch (Exception e) {
