...
public class ParametroLogic implements IParametroLogic {
    ...
    public void saveParametro(Parametro entity) throws Exception {
        ...
        try {
            ...
            if (getParametro(entity.getIdParametro()) != null) {
    ...
    public void deleteParametro(Parametro entity) throws Exception {
        ...
        if (entity.getIdParametro() == null) {
            throw new ZMessManager().new EmptyFieldException("idParametro");
        }

        try {
            parametroDAO.deleteById(entity.getIdParametro());
    ...
    public Parametro getParametro(Long idParametro) throws Exception {
        ...
        try {
            entity = parametroDAO.findById(idParametro);
        } catch (Exception e) {
