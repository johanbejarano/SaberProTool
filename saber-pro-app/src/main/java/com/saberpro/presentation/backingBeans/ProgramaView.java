...
public class ProgramaView implements Serializable {
    ...
    public String action_clear() {
        ...
        if (txtIdFacultad_Facultad != null) {
            ...
            txtIdFacultad_Facultad.setDisabled(true);
        }
    ...
    public void listener_txtId() {
        try {
            Long idPrograma = FacesUtils.checkLong(txtIdPrograma);
        ...
        if (entity == null) {
            ...
            txtUsuModificador.setDisabled(false);
            txtIdFacultad_Facultad.setValue(entity.getFacultad().getIdFacultad());
            txtIdFacultad_Facultad.setDisabled(false);
    ...
    public String action_edit(ActionEvent evt) {
        ...
        txtActivo.setValue(selectedPrograma.getActivo());
        txtActivo.setDisabled(false);
        txtDescripcion.setValue(selectedPrograma.getDescripcion());
        txtDescripcion.setDisabled(false);
        txtFechaCreacion.setValue(selectedPrograma.getFechaCreacion());
        txtFechaCreacion.setDisabled(false);
        txtFechaModificacion.setValue(selectedPrograma.getFechaModificacion());
        txtFechaModificacion.setDisabled(false);
        txtNombre.setValue(selectedPrograma.getNombre());
        txtNombre.setDisabled(false);
        txtUsuCreador.setValue(selectedPrograma.getUsuCreador());
        txtUsuCreador.setDisabled(false);
        txtUsuModificador.setValue(selectedPrograma.getUsuModificador());
        txtUsuModificador.setDisabled(false);
        txtIdFacultad_Facultad.setValue(selectedPrograma.getIdFacultad_Facultad());
        txtIdFacultad_Facultad.setDisabled(false);
    ...
    public String action_create() {
        try {
            ...
            entity.setFacultad((FacesUtils.checkLong(txtIdFacultad_Facultad) != null)
                ? businessDelegatorView.getFacultad(FacesUtils.checkLong(
                        txtIdFacultad_Facultad)) : null);
    ...
    public String action_modify() {
        try {
            if (entity == null) {
                Long idPrograma = new Long(selectedPrograma.getIdPrograma());
    ...
    public String action_modifyWitDTO(String activo, String descripcion,
        Date fechaCreacion, Date fechaModificacion, Long idPrograma,
        String nombre, Long usuCreador, Long usuModificador,
        Long idFacultad_Facultad) throws Exception {
        try {
