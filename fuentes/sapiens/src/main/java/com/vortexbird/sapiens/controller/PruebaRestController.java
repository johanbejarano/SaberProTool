...
public class PruebaRestController {
    ...
    public ResponseEntity<?> findById(@PathVariable("prueId") Integer prueId) {
        log.debug("Request to findById() Prueba");

        try {
            Prueba prueba = pruebaService.findById(prueId).get();

            return ResponseEntity.ok().body(pruebaMapper.pruebaToPruebaDTO(prueba));
        } catch (Exception e) {
    ...
    public ResponseEntity<?> findAll() {
        ...
        try {
            return ResponseEntity.ok().body(pruebaMapper.listPruebaToListPruebaDTO(pruebaService.findAll()));
        } catch (Exception e) {
            log.error(e.getMessage(), e);
    ...
    public ResponseEntity<?> save(@RequestBody PruebaDTO pruebaDTO) {
    ...
    public ResponseEntity<?> update(@RequestBody PruebaDTO pruebaDTO) {
    ...
    public ResponseEntity<?> delete(@PathVariable("prueId") Integer prueId) throws Exception {
    ...
    public ResponseEntity<?> getPruebasDeUsuarioCreador(@PathVariable("usuCreador") Long usuCreador) {
    ...
    public ResponseEntity<?> modificarPrueba(@RequestBody PruebaDTO pruebaDTO) {
    ...
    public ResponseEntity<?> getPrueba(@PathVariable("prueId") Integer prueId) {
